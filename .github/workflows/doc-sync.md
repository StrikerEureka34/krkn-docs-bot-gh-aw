...
steps:
  ...
  - name: Clone the parameter sources
    run: |
      ...
      git clone --depth 1 https://github.com/StrikerEureka34/krkn-hub.git "$RUNNER_TEMP/krkn-hub"
      git clone --depth 1 https://github.com/StrikerEureka34/krkn.git "$RUNNER_TEMP/krkn"
